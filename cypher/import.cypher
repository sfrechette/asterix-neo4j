...
USING PERIODIC COMMIT
LOAD CSV WITH HEADERS FROM "file:data/personnagealbum.csv" AS row
MATCH (personnage:Personnage {personnageId: row.PersonnageID})
MATCH (album:Album {albumId: row.AlbumID})
...
USING PERIODIC COMMIT
LOAD CSV WITH HEADERS FROM "file:data/compagnonaventure.csv" AS row
MATCH (personnage:Personnage {personnageId: row.PersonnageID})
